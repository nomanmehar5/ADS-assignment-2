...
def wbdata(filename,filename1,width,filename2,filename3):
    ...
    plt.bar(X_axis_sta + width*2, values_sd, width, label='Standard Deviation')

    #Title of the line chart
    plt.title("Bar plot with the values of countries population")
    ...
    df_Agri_land = df_Agri_land.dropna()
    ...
    df_ARB_land = df_ARB_land.dropna()
    ...
    """
        correlaion of population of three countries
    """
    corr = df1.corr()
    print('\n\n',corr)
